\documentclass[11pt]{article}
    ...
    % Document parameters
    % Document title
    \title{Dynamics of Rotational Motion}
...
\begin{table}[H]
	...
	\end{tabular}
\end{table}
\centering Table of $h$ vs $\omega^2$ for $m=30g$
\end{tcolorbox}
        
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{drm_files/drm_3_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{drm_files/drm_5_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{drm_files/drm_7_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{drm_files/drm_11_0.png}
    \end{center}
    { \hspace*{\fill} \\}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{drm_files/drm_12_0.png}
    \end{center}
    { \hspace*{\fill} \\}
